...
class CUstudVC: UIViewController {
    ...
    override func viewDidLayoutSubviews() {
        ...
        ageTextField.frame = CGRect(x: 30, y: nameTextField.bottom + 20, width: view.width - 80, height: 40)
        classTextField.frame = CGRect(x: 30, y: ageTextField.bottom + 20, width: view.width - 80, height: 40)
        SaveButton.frame = CGRect(x: 30, y: classTextField.bottom + 50, width: view.width - 80, height: 40)
    }
