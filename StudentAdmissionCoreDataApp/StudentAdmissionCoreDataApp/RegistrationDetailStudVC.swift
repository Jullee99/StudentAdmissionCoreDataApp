//
//  RegistrationDetailStudVC.swift
...
class RegistrationDetailStudVC: UIViewController {
    ...
    override func viewDidLayoutSubviews() {
        ...
        mybutton.frame = CGRect(x: 150, y: 600, width: 80, height: 40)
...
extension RegistrationDetailStudVC : UITableViewDataSource,UITableViewDelegate{
